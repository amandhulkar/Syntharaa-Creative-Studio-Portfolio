    ...
    >
      <div className="grid gap-16 lg:grid-cols-2 lg:items-start">
        ...
        >
          ...
          <div className="mt-2 flex flex-col gap-4 border-l-2 border-gold/60 pl-5">
            <div>
              ...
              <a
                ...
                className="text-base font-medium text-ink transition hover:text-maroon"
              >
                {STUDIO.email}
              </a>
            </div>
        ...
        >
          ...
          <div className="relative rounded-3xl bg-paper p-8 shadow-card sm:p-10">
            <ContactForm />
          </div>
        </motion.div>
      </div>
